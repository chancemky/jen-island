...
export const HAIRCUTS = {
  // ---------------- women
  bob:        { g: 'f', price: 0,   en: 'Classic Bob', vi: 'Tóc bob cổ điển', H: { f: 0.3, s: -0.6, b: -0.95, vol: 1.1, jaw: true } },
  long:       { g: 'f', price: 0,   en: 'Long & Straight', vi: 'Tóc dài thẳng', H: { f: 0.3, s: -0.5, b: -1.2, vol: 1.08, curtain: 13 } },
  wavy:       { g: 'f', price: 80,  en: 'Beach Waves', vi: 'Tóc xoăn sóng', H: { f: 0.28, s: -0.5, b: -1.2, vol: 1.1, curtain: 14, wavy: true } },
  ...
  lob:        { g: 'f', price: 120, en: 'Swept Lob', vi: 'Tóc lob rẽ ngôi', H: { f: 0.26, s: -0.58, b: -1.0, vol: 1.1, jaw: true, curtain: 5, sweep: 1 } },
  pixie:      { g: 'f', price: 110, en: 'Pixie Cut', vi: 'Tóc tém pixie', H: { f: 0.34, s: 0.0, b: -0.5, vol: 1.05, sweep: 1.4, tipsAmp: 0.13 } },
  curtain:    { g: 'f', price: 140, en: 'Curtain Bangs', vi: 'Mái bay dài', H: { f: 0.2, s: -0.5, b: -1.2, vol: 1.08, curtain: 13, cpart: 0.38, blunt: true } },
  ...
  curly:      { g: 'f', price: 170, en: 'Long Curls', vi: 'Tóc xoăn dài', H: { f: 0.25, s: -0.5, b: -1.1, vol: 1.16, curtain: 12, curls: true } },
  ...
  frenchbob:  { g: 'f', price: 130, en: 'French Bob', vi: 'Tóc bob Pháp', H: { f: 0.16, s: -0.45, b: -0.8, vol: 1.08, jaw: true, blunt: true } },
  shag:       { g: 'f', price: 140, en: 'Shag', vi: 'Tóc tỉa tầng', H: { f: 0.28, s: -0.5, b: -1.0, vol: 1.12, curtain: 9, messy: true, wavy: true, cpart: 0.2 } },
  ...
  wolf:       { g: 'f', price: 150, en: 'Wolf Cut', vi: 'Tóc wolf cut', H: { f: 0.26, s: -0.45, b: -1.0, vol: 1.13, curtain: 10, messy: true, tipsAmp: 0.15 } },
  sidepart:   { g: 'f', price: 140, en: 'Deep Side Part', vi: 'Rẽ ngôi lệch sâu', H: { f: 0.3, s: -0.5, b: -1.2, vol: 1.08, curtain: 14, sweep: 1.7, wavy: true } },
  // ---------------- men
  short:      { g: 'm', price: 0,   en: 'Short & Neat', vi: 'Tóc ngắn gọn', H: { f: 0.42, s: 0.05, b: -0.55, vol: 1.04 } },
  spiky:      { g: 'm', price: 0,   en: 'Spiky', vi: 'Tóc dựng', H: { f: 0.44, s: 0.1, b: -0.5, vol: 1.05, spikes: true } },
  crew:       { g: 'm', price: 70,  en: 'Crew Cut', vi: 'Tóc húi cua', H: { f: 0.5, s: 0.2, b: -0.45, vol: 1.02, tipsAmp: 0.04 } },
  ...
  curtains:   { g: 'm', price: 130, en: 'Middle Part', vi: 'Rẽ ngôi giữa', H: { f: 0.22, s: -0.1, b: -0.6, vol: 1.06, cpart: 0.42, blunt: true } },
  buzz:       { g: 'm', price: 60,  en: 'Buzz Cut', vi: 'Tóc cạo sát', H: { f: 0.62, s: 0.25, b: -0.2, vol: 1.0, blunt: true, buzz: true } },
  messy:      { g: 'm', price: 110, en: 'Messy Textured', vi: 'Tóc rối tự nhiên', H: { f: 0.36, s: 0.05, b: -0.55, vol: 1.07, messy: true, tipsAmp: 0.14 } },
  ...
  longm:      { g: 'm', price: 140, en: 'Shoulder Length', vi: 'Tóc dài ngang vai', H: { f: 0.3, s: -0.4, b: -0.9, vol: 1.07, curtain: 7, cpart: 0.25 } },
  curlytop:   { g: 'm', price: 150, en: 'Curly Top', vi: 'Tóc xoăn đỉnh', H: { f: 0.35, s: 0.25, b: -0.4, vol: 1.08, curls: true, fade: true } },
  afro:       { g: 'm', price: 160, en: 'Afro', vi: 'Tóc afro', H: { f: 0.4, s: -0.1, b: -0.6, vol: 1.26, curls: true } },
  crop:       { g: 'm', price: 120, en: 'Textured Crop', vi: 'Tóc crop', H: { f: 0.3, s: 0.15, b: -0.45, vol: 1.05, blunt: true, fade: true, messy: true } },
  bowl:       { g: 'm', price: 90,  en: 'Bowl Cut', vi: 'Tóc úp tô', H: { f: 0.12, s: -0.1, b: -0.35, vol: 1.07, blunt: true } },
  slick:      { g: 'm', price: 140, en: 'Slicked Back', vi: 'Tóc vuốt ngược', H: { f: 0.75, s: 0.15, b: -0.5, vol: 1.03, slick: true } },
  wavym:      { g: 'm', price: 130, en: 'Wavy Flow', vi: 'Tóc gợn sóng', H: { f: 0.33, s: -0.2, b: -0.7, vol: 1.08, wavy: true, sweep: 0.8 } },
  mullet:     { g: 'm', price: 150, en: 'Mullet', vi: 'Tóc mullet', H: { f: 0.4, s: 0.05, b: -0.5, vol: 1.05, curtain: 7, narrow: true } },
