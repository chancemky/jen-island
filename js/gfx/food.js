...
export const ICONS = {
  ...
  trophy: c => { box(c, -5, 8, 10, 4, 1.5, '#b77a4f'); box(c, -2, 3, 4, 6, 1, '#e3a52c'); c.beginPath(); c.moveTo(-9, -11); c.lineTo(9, -11); c.quadraticCurveTo(9, 5, 0, 5); c.quadraticCurveTo(-9, 5, -9, -11); c.fillStyle = '#ffd35a'; c.fill(); c.strokeStyle = INK; c.lineWidth = 1.2; c.stroke(); c.beginPath(); c.arc(-9, -5, 4, Math.PI * 0.5, Math.PI * 1.5); c.moveTo(9, -9); c.arc(9, -5, 4, -Math.PI * 0.5, Math.PI * 0.5); c.stroke(); c.fillStyle = 'rgba(255,255,255,.7)'; c.fillRect(-5, -8, 2.4, 8); },
  key: c => { c.save(); c.rotate(-0.6); circ(c, -6, 0, 6, '#ffd35a'); circ(c, -6, 0, 2.4, '#fff8ea', INK, 0.8); box(c, -1, -2, 16, 4, 1.5, '#ffd35a'); box(c, 9, 1, 3, 5, 1, '#ffd35a'); box(c, 4, 1, 3, 4, 1, '#ffd35a'); c.restore(); },
  shirt: c => { poly(c, [-6, -11, -13, -6, -10, 0, -7, -2, -7, 11, 7, 11, 7, -2, 10, 0, 13, -6, 6, -11, 3, -8, -3, -8], '#f4a9b8'); c.beginPath(); c.moveTo(-3, -8); c.quadraticCurveTo(0, -4, 3, -8); c.strokeStyle = INK; c.lineWidth = 1; c.stroke(); circ(c, 0, 0, 1, '#fff', null); circ(c, 0, 4, 1, '#fff', null); },
